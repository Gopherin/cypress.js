...
describe('Проверка авторизации', function () {
   ...
   it('Верный пароль и верный логин', function () {
    ...
    it('Забыли пароль', function () {
        ...
        cy.get(recovery_password_page.email).type('gibrid29@mail.ru');
        cy.get(recovery_password_page.send_button).should('be.visible');
    ...
    it('Ошибка валидации', function () {
        cy.get(main_page.email).type('germandolniko.ru');
        cy.get(main_page.password).type(data.password);
        cy.get(main_page.login_button).click();
